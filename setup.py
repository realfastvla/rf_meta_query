...
#
setup_keywords['name'] = 'rf_meta_query'
setup_keywords['description'] = 'Run meta data queries related to an FRB candidate'
setup_keywords['author'] = 'Realfast'
setup_keywords['author_email'] = 'realfast'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/realfastvla/rf_meta_query'
#
